class Libreria
{
                        ...
                        if (confirmar == "si")
                        {
                            ...
                            foreach (var Usuario in Prestamo.DiccionarioPrestamos())
                            {
                                foreach (var Pres in Usuario.Value)
                                {
                                    ...
                                    {
                                        Prestamo.DiccionarioPrestamos().Remove(Libros[Menus.Opcion - 1].Titulo);
                                    }
                                }
                            }
    ...
    public static void BuscarLibro()
    {
        do
        {
            ...
            {
                case 1:
                    BuscarLibroPor(Menus.Opcion, "Título");
                    Console.ReadKey();
                    break;
                case 2:
                    BuscarLibroPor(Menus.Opcion, "Autor");
                    Console.ReadKey();
                    break;
                case 3:
                    BuscarLibroPor(Menus.Opcion, "Anyo");
                    Console.ReadKey();
                    break;
                case 4:
                    BuscarLibroPor(Menus.Opcion, "Género");
                    Console.ReadKey();
                    break;
                case 5:
                    BuscarLibroPor(Menus.Opcion, "Reseñas");
                    Console.ReadKey();
                    break;
                case 0:
                    Salir = true;
    ...
    static void BuscarLibroPor(int campo, string tipo)
    {
        ...
        {
            Valor = Comprobaciones.PedirString($"Escribe el {tipo} del libro", 30);
        }
        ...
        {
            if (tipo == "Título" && Valor == Lib.Titulo)
            {
                Console.WriteLine($"  {HayResultados + 1}. {Lib.Titulo}");
                Console.WriteLine("");
                HayResultados += 1;
            }
            else if (tipo == "Autor" && Valor == Lib.Titulo)
            {
                Console.WriteLine($"  {HayResultados + 1}. {Lib.Titulo}");
            ...
            else if (tipo == "Anyo" && Valor == Lib.Titulo)
            {
                Console.WriteLine($"  {HayResultados + 1}. {Lib.Titulo}");
            ...
            else if (tipo == "Género" && Valor == Lib.Titulo)
            {
                Console.WriteLine($"  {HayResultados + 1}. {Lib.Titulo}");
        ...
        {   // Uno para Reseñas y el otro para los demás
            ...
            {
                Console.WriteLine($"Hay {HayResultados} resultado/s para {Valor}.");
                Console.WriteLine("");
            }
