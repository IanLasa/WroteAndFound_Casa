                ...
                if (Comprobaciones.HayLibros())
                {
                    ...
                    if (Menus.Opcion != 0)
                    {
                        ...
                        else
                        {
                            ...
                            Prestamos[Usuario.UsuarioActual].Add(ListaDeLibros[Menus.Opcion].Titulo);
                            Salir = true;
            ...
            while (!Salir)
            {
                ...
                if (Comprobaciones.HayLibros())
                {
                    ...
                    if (Prestamos[Usuario.UsuarioActual].Count > 0)
                    {
                        ...
                        Console.WriteLine("----------------------------------------------------");
                        Console.WriteLine("");
                        Comprobaciones.PedirNumero("Que libro quieres devolver", 1, Prestamos[Usuario.UsuarioActual].Count, false);
                        Console.Clear();
                        Console.WriteLine("");
